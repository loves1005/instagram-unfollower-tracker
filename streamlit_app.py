...
1. Instagram 앱 → 프로필 → **메뉴(☰)**
2. **설정 및 개인정보 → 계정 센터**
3. 내 정보 및 권한 → **내 정보 다운로드**
4. 일부 정보 선택 → **팔로워 및 팔로잉** 체크
5. 형식: **JSON** / 기간: **전체 기간** 선택 후 요청
6. 이메일로 온 링크에서 ZIP 다운로드 → 압축 해제
7. `connections/followers_and_following/` 폴더에서
   - `followers_1.json`
   - `following.json`
   두 파일을 업로드하세요.

> ⚠️ 데이터 수신까지 최대 48시간 소요될 수 있습니다.
""")
    st.markdown("---")
